...
class DemoChild2 extends DemoChild1{
        ...
        void fun(){
                super.fun();
                System.out.println("DemoChild1 x : " + super.super.x);            // error
...
/* Program3.java:37: error: <identifier> expected
                System.out.println("DemoChild1 x : " + super.super.x);
                                                             ^
Program3.java:37: error: not a statement
                System.out.println("DemoChild1 x : " + super.super.x);
                                                                  ^
Program3.java:37: error: ';' expected
                System.out.println("DemoChild1 x : " + super.super.x); */
