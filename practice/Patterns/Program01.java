...
class Pattern {
    ...
    void pattern83(int rows) {
        if (rows % 2 == 1) {
            int num = 1;
            int mid = (int) (rows / 2 + 1);                            // 1 2 3 4 5 6 7
            int fix = 4;                                               // 24 25 26 27 28 29 8
            int m = 0;                                                 // 23 40 41 42 43 30 9
            int last = 5 * (mid - 1) + (3 * (mid - 2));                // 22 39 48 49 44 31 10
            int first = 9 * (mid - 2) - (mid - 3);                     // 21 38 47 46 45 32 11
            int nextM = 0;                                             // 20 37 36 35 34 33 12
            int range = 0;                                             // 19 18 17 16 15 14 13
            int forLast = mid - 3;
            for (int i = 1; i <= rows; i++) {
                if (i == 1) {
                    for (int j = 1; j <= rows; j++) {
                    ...
                    last = (5 * (mid - 1) + (3 * (mid - 2))) - ((i - 2) * 8);
                    first = (9 * (mid - 2) - (mid - 3)) + 8;
                    for (int j = 1; j <= rows; j++) {
                        if (j == 1) {
                    ...
                    int temp = ((rows - 1) * 4) - (nextM);
                    first = (9 * (mid - 2) - (mid - 3)) + 8;
                    last = (5 * (mid - 1) + (3 * (mid - 2))) - (forLast * 8);
                    for (int j = 1; j <= rows; j++) {
                        if (j == 1) {
                            System.out.printf("%4d", temp);
                        } else if (j <= m) {
            ...
            int fix = 4;
            int m = 1;
            int first = (5 * ((mid - 1) - 1) + (3 * ((mid - 1) - 2))); // 1 2 3 4 5 6 7 8
            int last = 9 * (mid - 2) - (mid - 3);                      // 28 29 30 31 32 33 34 9
            int nextM = 0;                                             // 27 48 49 50 51 52 35 10
            int forLast = rows / 2 - 3;                                // 26 47 60 61 62 53 36 11
            int range2 = 3;                                            // 25 46 59 64 63 54 37 12
            for (int i = 1; i <= rows; i++) {                          // 24 45 58 57 56 55 38 13
                if (i == 1) {                                          // 23 44 43 42 41 40 39 14
                    for (int j = 1; j <= rows; j++) {                  // 22 21 20 19 18 17 16 15
                        System.out.printf("%4d", num);
                        num++;
                    }
                } else if (i == rows) {
                    ...
                    int temp = (((rows - 1) * 4) - m) + 1;
                    boolean oneTime = true;
                    first = (5 * ((mid - 1) - 1) + (3 * ((mid - 1) - 2))) + 8;
                    last = (9 * (mid - 2) - (mid - 3)) - ((i - 2) * 8);
                    for (int j = 1; j <= rows; j++) {
                        if (j == 1) {
                            System.out.printf("%4d", temp);
                        } else if (j <= m) {
    ...
    void pattern84(int rows) {
        if (rows % 2 == 1) {
            ...
            int m = 0;
            int range = 0;
            for (int i = 1; i <= rows; i++) {                                           // 49 48 47 46 45 44 43
                if (i == 1) {                                                           // 26 25 24 23 22 21 42
                    for (int j = 1; j <= rows; j++) {                                   // 27 10 9 8 7 20 41
                        System.out.printf("%4d", ((rows * rows - j) + 1));       // 28 11 2 1 6 19 40
                    }                                                                   // 29 12 3 4 5 18 39
                } else if (i <= mid) {                                                  // 30 13 14 15 16 17 38
                    int num = (((rows - 2) * (rows - 2)) + 1) + m;                      // 31 32 33 34 35 36 37
                    int firstGap = (9 * (mid - 2) - (mid - 3)) + 8;
                    int lastGap = ((5 * (mid - 1)) + (3 * (mid - 2))) - (8 * m);
                    for (int j = 1; j <= rows; j++) {
                        if (j == 1) {
                            System.out.printf("%4d", num);
                        } else if (j <= m + 1) {
                    ...
                    int num = (((rows - 2) * (rows - 2)) + 1) + (i - 2);
                    int firstGap = (9 * (mid - 2) - (mid - 3)) + 8;
                    int lastGap = ((5 * (mid - 1)) + (3 * (mid - 2))) - (8 * (m - 2));
                    for (int j = 1; j <= rows; j++) {
                        if (j == 1) {
                            System.out.printf("%4d", num);
                        } else if (j <= m) {
            ...
            int m = 0;
            int range = 0;
            for (int i = 1; i <= rows; i++) {                              // 64 63 62 61 60 59 58 57
                if (i == 1) {                                              // 37 36 35 34 33 32 31 56
                    for (int j = 1; j <= rows; j++) {                      // 38 17 16 15 14 13 30 55
                        System.out.printf("%4d", ((rows * rows - j) + 1)); // 39 18 5 4 3 12 29
                                                                           // 54
                    }                                                      // 40 19 6 1 2 11 28 53
                } else if (i <= mid) {                                     // 41 20 7 8 9 10 27 52
                    int num = (((rows - 2) * (rows - 2)) + 1) + m;         // 42 21 22 23 24 25 26 51
                    int lastGap = (9 * (mid - 2) - (mid - 3)) - (8 * m);   // 43 44 45 46 47 48 49 50
                    int firstGap = ((5 * (mid - 2)) + (3 * (mid - 3))) + 8;
                    for (int j = 1; j <= rows; j++) {
                        if (j == 1) {
                            System.out.printf("%4d", num);
                        } else if (j <= m + 1) {
                    ...
                    int num = (((rows - 2) * (rows - 2)) + 1) + (i - 2);
                    int lastGap = (9 * (mid - 2) - (mid - 3)) - (8 * (m - 2));
                    int firstGap = ((5 * (mid - 2)) + (3 * (mid - 3))) + 8;
                    for (int j = 1; j <= rows; j++) {
                        if (j == 1) {
                            System.out.printf("%4d", num);
        ...
        public static void main(String[] args) {
                ...
                while (true) {
                        System.out.println("Available Patterns:\n" +
                                        "01 : Pattern01 " + "       " + "21 : Pattern21 " + "       "
                                        + "41 : Pattern41 " + "       " + "61 : Pattern61 " + "       "
                                        + "81 : Pattern81\n" +
                                        "02 : Pattern02 " + "       " + "22 : Pattern22 " + "       "
                                        + "42 : Pattern42 " + "       " + "62 : Pattern62 " + "       "
                                        + "82 : Pattern82\n" +
                                        "03 : Pattern03 " + "       " + "23 : Pattern23 " + "       "
                                        + "43 : Pattern43 " + "       " + "63 : Pattern63 " + "       "
                                        + "83 : Pattern83\n" +
                                        "04 : Pattern04 " + "       " + "24 : Pattern24 " + "       "
                                        + "44 : Pattern44 " + "       " + "64 : Pattern64 " + "       "
                                        + "84 : Pattern84\n" +
                                        "05 : Pattern05 " + "       " + "25 : Pattern25 " + "       "
                                        + "45 : Pattern45 " + "       " + "65 : Pattern65\n" +
                                        "06 : Pattern06 " + "       " + "26 : Pattern26 " + "       "
                                        + "46 : Pattern46 " + "       " + "66 : Pattern66\n" +
                                        "07 : Pattern07 " + "       " + "27 : Pattern27 " + "       "
                                        + "47 : Pattern47 " + "       " + "67 : Pattern67\n" +
                                        "08 : Pattern08 " + "       " + "28 : Pattern28 " + "       "
                                        + "48 : Pattern48 " + "       " + "68 : Pattern68\n" +
                                        "09 : Pattern09 " + "       " + "29 : Pattern29 " + "       "
                                        + "49 : Pattern49 " + "       " + "69 : Pattern69\n" +
                                        "10 : Pattern10 " + "       " + "30 : Pattern30 " + "       "
                                        + "50 : Pattern50 " + "       " + "70 : Pattern70\n" +
                                        "11 : Pattern11 " + "       " + "31 : Pattern31 " + "       "
                                        + "51 : Pattern51 " + "       " + "71 : Pattern71\n" +
                                        "12 : Pattern12 " + "       " + "32 : Pattern32 " + "       "
                                        + "52 : Pattern52 " + "       " + "72 : Pattern72\n" +
                                        "13 : Pattern13 " + "       " + "33 : Pattern33 " + "       "
                                        + "53 : Pattern53 " + "       " + "73 : Pattern73\n" +
                                        "14 : Pattern14 " + "       " + "34 : Pattern34 " + "       "
                                        + "54 : Pattern54 " + "       " + "74 : Pattern74\n" +
                                        "15 : Pattern15 " + "       " + "35 : Pattern35 " + "       "
                                        + "55 : Pattern55 " + "       " + "75 : Pattern75\n" +
                                        "16 : Pattern16 " + "       " + "36 : Pattern36 " + "       "
                                        + "56 : Pattern56 " + "       " + "76 : Pattern76\n" +
                                        "17 : Pattern17 " + "       " + "37 : Pattern37 " + "       "
                                        + "57 : Pattern57 " + "       " + "77 : Pattern77\n" +
                                        "18 : Pattern18 " + "       " + "38 : Pattern38 " + "       "
                                        + "58 : Pattern58 " + "       " + "78 : Pattern78\n" +
                                        "19 : Pattern19 " + "       " + "39 : Pattern39 " + "       "
                                        + "59 : Pattern59 " + "       " + "79 : Pattern79\n" +
                                        "20 : Pattern20 " + "       " + "40 : Pattern40 " + "       "
                                        + "60 : Pattern60 " + "       " + "80 : Pattern80\n" +
                                        "0 : Exit.\n");
